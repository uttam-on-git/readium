import { SignupInput } from "@uttam_npm/readium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Romendra Uttam..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="uttam_rip" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            username: e.target.value
                        })
                    }} />
                    <LabelledInput label="Password" type={"password"} placeholder="P@ssw0rd123" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
